                                   ...
                                   <div class="media-body">
                                      <a href="user-profile.html">
                                         ...
                                         <span class="discribe">Extremity sweetness difficult behaviour he of. On
                                            disposal of as landlord horrible. Afraid at highly months do things on
                                            at.</span>
                                         <span class="time">
                                            <time>Just now</time>...
                                         </span>
                                ...
                                <div class="media media-sm bg-warning-10 p-4 mb-0">
                                   ...
                                   <div class="media-body">
                                      <a href="user-profile.html">
                                         <span class="title mb-0">John Doe</span>
                                         <span class="discribe">Extremity sweetness difficult behaviour he of. On
                                            disposal of as landlord horrible. Afraid
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                       ...
                       <li class="dropdown-footer">
                          <form method="post" id="logout-form" action="{{route('logout')}}">
                             @csrf
                             <a class="dropdown-link-item logout-btn"> <i class="mdi mdi-logout"></i> 
                                Log Out
                             </a>
